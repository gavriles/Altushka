...
contract Altushka {
    ...
    function mint() external payable {
        ...
        string memory tokenURI = string(abi.encodePacked("https://purple-odd-dragonfly-67.mypinata.cloud/ipfs/QmezCJ7SY2j5BwhQewRvAPsDnqCjhPz8epCPqmtjvRXSZo/", uint2str(tokenId), ".png"));
